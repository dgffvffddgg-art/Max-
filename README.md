...
البوت بيستخدم **Google Gemini** (مجاني) عشان يفهم السياق، وبيصنف كل رسالة (اللي عدّت الفلتر التقليدي) لواحدة من 3 حالات:
...
لو مش حاطط مفتاح Gemini (`GEMINI_API_KEY` فاضي)، البوت يشتغل عادي بالفلتر التقليدي بس (سبام/شتايم/فلود) من غير الميزتين دول.
